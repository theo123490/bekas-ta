...
v_dense_layer = keras.layers.Dense(100,activation="softsign")(vector_input)
...
save_best_val_acc = keras.callbacks.ModelCheckpoint('best_model_val_acc'+str(epoch_num)+'.h5', 
                                           save_best_only=True, 
                                           monitor='val_acc', 
                                           mode='max')

save_best_acc = keras.callbacks.ModelCheckpoint('best_model_acc'+str(epoch_num)+'.h5', 
                                           save_best_only=True, 
                                           monitor='acc', 
                                           mode='max')
